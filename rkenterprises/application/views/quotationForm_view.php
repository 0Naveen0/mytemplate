        ...
        <fieldset>  
			...
			<div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    <input type="text" class="form-control" id="customerfathername" name='customerfathername'   required="required" >
                </div>
            </div>
			<div class="form-group">
			...
			<div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    <input type="text" class="form-control" id="customeraddressline2" name='customeraddressline2'   required="required" >
                </div>
            </div>
			<div class="form-group">
                ...
                <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control" id="customerdistrict" name='customerdistrict'   required="required" >
                </div>
				<label for="customerstate" class="col-sm-3 control-label">State</label>
                <div class="col-sm-3">

                    <input type="text" class="form-control" id="customerstate" name='customerstate'   required="required" >
                </div>
            </div>
			<div class="form-group">
                ...
                <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control" id="customerpin" name='customerpin' maxlength=6 minlength=6  required="required" >
                </div>
				<label for="customercontact" class="col-sm-3 control-label">Contact</label>
                <div class="col-sm-3">

                    <input type="text" class="form-control" id="customercontact" name='customercontact' minlength=10 maxlength=10  required="required" >
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    ...
                    <button type='submit' class="btn btn-default " name="generateQuotationBtn" value='generateQuotation'>Generate</button>&nbsp;
