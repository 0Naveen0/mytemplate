...
<div class="d-print-none">
    ...
    <div >
           ...
           <div class='row'><div class="col-sm-2 small">
                <button  class="btn btn-default " name="addEnquiryBtn" data-toggle='modal' data-target='#enquiryAddModal' value='enquiryAdd' ><span class="glyphicon glyphicon-plus" aria-hidden="true" aria-label="Add"></span>Add New</button>
                </div>
                <form role="form" class="form-horizontal small pull-right" method='post' id="searchEnquiryfrm">
        <fieldset> 
                <div class="col-sm-4 small">      
                    <select class="form-control" name="criteriaSearchEnquiry">
                ...
                <div class="col-sm-3 small">
                    ...
                    <input type="text" class="form-control" id="searchTextEnquiry" name='searchTextEnquiry'  required>
                </div>
                <div class="col-sm-2 small">
                <button type='submit' class="btn btn-default " name="searchEnquiryBtn" value='enquirySearch' ><span class="glyphicon glyphicon-search" aria-hidden="true" aria-label="Search"></span></button>
                </div>
...
<?php
if(count($enquirydata)){
 echo "<div class='small'><div class='small'><div class='table-responsive small'>";
  echo          "<table class='table table-striped table-bordered small dataTable' id='searchEnquiryTable' name='searchEnquiryTable'><thead>";
 ...
 echo '<th>Branch</th><th>Modal</th><th>Action</th>
  ...
  echo "<td>" . $row['customeraddressline1'] ."&comma;". $row['customeraddressline2']."&comma;".$row['customerdistrict']."&comma;".$row['customerstate']."&comma;".$row['customerpin'].
   ...
   echo "<td>" . $row['enquirystatus'] . "</td>";
   echo "<td>" . $row['branchname']."&comma;".$row['branchid'] . "</td>";
   echo "<td>" . $row['modalname'] ."&comma;".$row['modalid'] .  "</td>";
   echo "<td>";
   echo "<button type='button' class='btn btn-default btn-xs' name='editEnquiryBtn' data-toggle='modal' data-target='#enquiryModifyModal' data-customerid=".$row['customerid']." value=".$row['customerid']."><span class='glyphicon glyphicon-pencil'></span></button>";
                       
  echo "<button type='button' class='btn btn-default btn-xs' name='deleteEnquiryBtn' value=".$row['customerid']."><span class='glyphicon glyphicon-trash'></span></button>";
  if($row['enquirystatus']==="active"){
  echo "<button type='button' class='btn btn-default btn-xs' data-toggle='modal' data-target='#FollowUpModal' data-customerid=".$row['customerid']." name='FollowUpBtn' value=".$row['customerid']."><span class='glyphicon glyphicon-piggy-bank'></span></button>";
  }
  echo "</td></tr>";
