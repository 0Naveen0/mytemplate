...
class SalesmanModel extends CI_Model {
    function __construct() {
     ...
     public function addSalesman($data){
         ...
         */
        $query=$this->db->insert('salesman',$data);
        if($query){
       return "Salesman Added Successfully";
       }else{
    ...
    // public function addCustomer(){}
       ...
       public function getSalesmanName($salesmanid){
        $salesmanname="na";
         $query = $this->db->select('salesmanname')
                ->from('salesman')
    ...
    public function getAllSalesman(){
       ...
       // $display="";
        ...
        if ($query->num_rows() === 0) {
           // $display="<option>No Record Found</option>";
            $displayList = array('salesmanid'=>"0",'salesmanname'=>"NA");
            //echo $display;
            //echo $displayUsers;
           // return $displayUsers;
        } else {
