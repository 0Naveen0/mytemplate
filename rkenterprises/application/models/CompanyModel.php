 ...
 * isCompanyExist($gstno)
 * addCompany($data)
 * editCompany($data,$companyid)
 * deleteCompany()
 * searchCompany($searchtext,$criteria)
...
class CompanyModel extends CI_Model {
    function __construct() {
     ...
     public function isCompanyExist($gstno){
        $companyid=0;
         $query = $this->db->select('companyid')
               ->from('company')
                ->where('companygst',$gstno)
                ->get();
     ...
     public function addCompany($data){
         $gstno=$data['gstno'];
         if($this->isCompanyExist($gstno)===0){
    ...
    //  }
     ...
     //Vehicle Update
	 public function editCompany($data,$companyid){
	     $message="Failed";
    ...
    // public function addCustomer(){}
       ...
       public function searchCompany($searchtext,$criteria){
             $field = $criteria;
            $order = 'DESC';
             $query = $this->db->select('*')
               ...
               ->order_by($field, $order)
                ...
                $data=array();
            $data[0] = array('companyname'=>'NA','companyaddressline1'=>'NA','companyaddressline2'=>'NA','companydistrict'=>'NA','companystate'=>'NA',
                'companypin'=>'NA','companycontact'=>'NA','companygst'=>'NA','companypan'=>'NA',
                'statecode'=>'NA','companyemail'=>"",'bankdetails'=>"NA");
             ...
             $data[$i++]=array('companyname'=>$row->companyname,'companyaddressline1'=>$row->companyaddressline1,'companyaddressline2'=>$row->companyaddressline2,'companydistrict'=>$row->companydistrict,'companystate'=>$row->companystate,'companypin'=>$row->companypin,
                'companycontact'=>$row->companycontact,'companygst'=>$row->companygst,'companypan'=>$row->companypan,'statecode'=>$row->statecode,
                'companyemail'=>$row->companyemail,'bankdetails'=>$row->bankdetails);
                }
     ...
     public function  getChallanId($vehicleid){
       ...
       $companyDetail = array();
        ...
        if ($query->num_rows() === 0) {
            ...
            $companyDetail[0] = array('companyname'=>'NA','companyaddressline1'=>'NA','companyaddressline2'=>'NA','companydistrict'=>'NA','companystate'=>'NA',
                'companypin'=>'NA','companycontact'=>'NA','companygst'=>'NA','companypan'=>'NA',
                'statecode'=>'NA','companyemail'=>"",'bankdetails'=>"NA");
           ...
           return  $companyDetail;
            ...
            foreach ($query->result() as $row) {
                ...
                $data=array('companyname'=>$row->companyname,'companyaddressline1'=>$row->companyaddressline1,'companyaddressline2'=>$row->companyaddressline2,'companydistrict'=>$row->companydistrict,'companystate'=>$row->companystate,'companypin'=>$row->companypin,
                'companycontact'=>$row->companycontact,'companygst'=>$row->companygst,'companypan'=>$row->companypan,'statecode'=>$row->statecode,
                'companyemail'=>$row->companyemail,'bankdetails'=>$row->bankdetails);
               $companyDetail[$i]=$data;
    ...
    public function getCompanyList(){
        ...
        $query = $this->db->select('companyid,companyname')
                ->from('company')
                ->order_by($field, $order)
                ->get();
        ...
        if ($query->num_rows() === 0) {
            //$display="<option>No Record Found</option>";
            $displayCompany = array('message'=>"No Record Found");
           // echo $display;
            //echo $displayUsers;
           return $displayCompany;
            ...
            foreach ($query->result() as $row) {
                ...
                $data=array('companyid'=>$row->companyid,'companyname'=>$row->companyname);
                $displayCompany[$i++]=$data;
            // echo $row->chasisno;
